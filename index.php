        ...
        <nav class="navbar">
            <div class="container">
                ...
                <ul class="nav-links">
                    ...
                    <li><a href="#fomulario">FORMULÁRIO</a></li>
    ...
    <main>
        ...
        <section id="home">
            ...
            <div class="col-6 text-sobre">
                <p>
                    No mundo atual, manter as finanças pessoais organizadas é fundamental para alcançar estabilidade e segurança financeira. Ao mesmo tempo, a necessidade de acompanhar informações importantes do dia a dia também é crucial. Nesse cenário, apresentamos o Poupe Bem, um WebSite inovador que combina os recursos de uma plataforma financeira com cursos que irão mudar o seu pensamento, simplificando a vida financeira e pessoal de seus usuários.
                </p>
                <br>
                <p> Poupe Bem permite que você mantenha um foco financeiro em uma interface intuitiva. Você pode adquirir diversos conhecimentos na área de finanças e muito mais. Selecionamos os melhores cursos em alta no mercado, para que você possa adquirir o melhor conhecimento, se aprimorando em finanças deixando o gasto excessivo de lado, controlando os impulsos do dia a dia. Afinal aqui nós iremos lhe ensinar a ter um bom relacionamento com o dinheiro.</p>
            </div>
